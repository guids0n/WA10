...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // 👉 O SEGREDO: Salva a referência do formulário antes do "await"
    ...
    try {
      ...
      if (response.ok) {
        ...
        // 👉 Usa a variável salva que não se perde no tempo assíncrono
        formulario.reset();
      }
    } catch (err) {
    ...
    <>
      ...
      <main id="pag-servicos">
        ...
        <div id="servicos">
          {/* SERVIÇO 1 */}
          <div className="card">
            <Link href="/servicos/consultoria-contabil" style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          {/* SERVIÇO 2 */}
          <div className="card">
            <Link href="/servicos/abertura-de-empresas" style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          {/* SERVIÇO 3 */}
          <div className="card">
            <Link href="/servicos/gestao-financeira" style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          {/* SERVIÇO 4 */}
          <div className="card">
            <Link href="/servicos/assessoria-trabalhista" style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          {/* SERVIÇO 5 */}
          <div className="card">
            <Link href="/servicos/regularizacao-fiscal" style={{ textDecoration: 'none', color: 'inherit' }}>
          ...
          {/* SERVIÇO 6 */}
          <div className="card">
            <Link href="/servicos/atendimento-remoto" style={{ textDecoration: 'none', color: 'inherit' }}>
